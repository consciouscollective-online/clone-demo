...
var len__4730__auto___9785 = arguments.length;
var i__4731__auto___9786 = (0);
while(true){
if((i__4731__auto___9786 < len__4730__auto___9785)){
args__4736__auto__.push((arguments[i__4731__auto___9786]));

var G__9787 = (i__4731__auto___9786 + (1));
i__4731__auto___9786 = G__9787;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9782){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9783,G__9784,seq9782__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9788_SHARP_){
return (!((cljs.core.meta.call(null,p1__9788_SHARP_) == null)));
})))){
...
var map__9789 = opts;
var map__9789__$1 = (((((!((map__9789 == null))))?(((((map__9789.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9789.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9789):map__9789);
var markup_db = cljs.core.get.call(null,map__9789__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9793){var _e__8770__auto__ = e9793;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e9795){var _e__8770__auto__ = e9795;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9797 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9798 = devtools.formatters.state.get_current_state.call(null);
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9798;

try{var map__9799 = opts;
...
var markup_db = cljs.core.get.call(null,map__9799__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9797;
}});
...
;
var temp__5455__auto___9804 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___9804)){
var managed_print_level_9805 = temp__5455__auto___9804;
var _STAR_print_level_STAR__orig_val__9802_9806 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9803_9807 = managed_print_level_9805;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9803_9807;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR__orig_val__9802_9806,_STAR_print_level_STAR__temp_val__9803_9807,managed_print_level_9805,temp__5455__auto___9804,writer,opts,job_fn){
return (function (p1__9801_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__9801_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__9802_9806,_STAR_print_level_STAR__temp_val__9803_9807,managed_print_level_9805,temp__5455__auto___9804,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9802_9806;
}} else {
job_fn.call(null);
}
