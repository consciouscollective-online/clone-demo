...
var G__9756 = devtools.prefs.pref.call(null,v);
v = G__9756;
continue;
} else {
return v;
...
}catch (e9759){var _e__8770__auto__ = e9759;
return false;
}})();
...
}catch (e9763){var _e__8770__auto__ = e9763;
return false;
}})();
...
}catch (e9765){var _e__8770__auto__ = e9765;
return false;
}}
}
});
...
var vec__9767 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9767,(0),null);
var name = cljs.core.nth.call(null,vec__9767,(1),null);
...
return cljs.core.some.call(null,(function (p1__9770_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9770_SHARP_);
}),template);
});
