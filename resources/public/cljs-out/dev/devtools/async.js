...
var o__8763__auto___10815 = (function (){var o__8763__auto__ = (function (){var o__8763__auto__ = Promise;
return (o__8763__auto__["resolve"]).call(o__8763__auto__);
})();
return (o__8763__auto__["then"]).call(o__8763__auto__,callback);
})();
(o__8763__auto___10815["catch"]).call(o__8763__auto___10815,devtools.async.rethrow_outside_promise);
...
var G__10816_10817 = Error;
var target__8768__auto___10818 = G__10816_10817;
if(cljs.core.truth_(target__8768__auto___10818)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10816_10817)].join(''),"\n","target__8768__auto__"].join('')));
}

(target__8768__auto___10818["stackTraceLimit"] = Infinity);
