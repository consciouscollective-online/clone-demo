...
var G__9597 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__9597,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__9597;
}
});
...
var len__4730__auto___9602 = arguments.length;
var i__4731__auto___9603 = (0);
while(true){
if((i__4731__auto___9603 < len__4730__auto___9602)){
args__4736__auto__.push((arguments[i__4731__auto___9603]));

var G__9604 = (i__4731__auto___9603 + (1));
i__4731__auto___9603 = G__9604;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq9599){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9600,G__9601,seq9599__$2);
});
...
var file = cljs.core.get.call(null,map__9606__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__9606__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__9606__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__9606,map__9606__$1,file,line,column){
return (function (p1__9605_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__9605_SHARP_));
});})(map__9606,map__9606__$1,file,line,column))
...
var temp__5457__auto___9608 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9608)){
var message_9609 = temp__5457__auto___9608;
cljs.core.println.call(null,message_9609);
} else {
}
...
var temp__5457__auto___9610 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___9610)){
var message_9611 = temp__5457__auto___9610;
cljs.core.println.call(null,message_9611);
} else {
}
...
var output_dir__$1 = (function (){var G__9612 = output_dir;
...
var G__9614 = exception.stack;
var G__9614__$1 = (((G__9614 == null))?null:clojure.string.split_lines.call(null,G__9614));
var G__9614__$2 = (((G__9614__$1 == null))?null:cljs.core.get.call(null,G__9614__$1,depth));
if((G__9614__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__9614__$2);
}
} else {
...
var vec__9615 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__9615,(0),null);
var column = cljs.core.nth.call(null,vec__9615,(1),null);
var vec__9618 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__9618,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__9618,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__9618,(2),null);
...
var m__$1 = (function (){var G__9621 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__9625 = (function (){var G__9624 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__9624);
} else {
return G__9624;
}
})();
...
return cljs.core.vary_meta.call(null,G__9626,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__9630 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__9630,(0),null);
var types = vec__9630;
...
return cljs.core.map.call(null,(function (p__9633){
var vec__9634 = p__9633;
var ns = cljs.core.nth.call(null,vec__9634,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__9634,(1),null);
return ((function (vec__9634,ns,vars__$1){
return (function (){
...
var G__9637 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__9637,G__9637__$1,env,once_fixtures,each_fixtures,vec__9634,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__9637,G__9637__$1,env,once_fixtures,each_fixtures,vec__9634,ns,vars__$1){
return (function (){
var seq__9638 = cljs.core.seq.call(null,vars__$1);
var chunk__9639 = null;
var count__9640 = (0);
var i__9641 = (0);
while(true){
if((i__9641 < count__9640)){
var v = cljs.core._nth.call(null,chunk__9639,i__9641);
var temp__5457__auto___9643 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9643)){
var t_9644 = temp__5457__auto___9643;
each_fixture_fn.call(null,((function (seq__9638,chunk__9639,count__9640,i__9641,t_9644,temp__5457__auto___9643,v,each_fixture_fn,G__9637,G__9637__$1,env,once_fixtures,each_fixtures,vec__9634,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9644)));
});})(seq__9638,chunk__9639,count__9640,i__9641,t_9644,temp__5457__auto___9643,v,each_fixture_fn,G__9637,G__9637__$1,env,once_fixtures,each_fixtures,vec__9634,ns,vars__$1))
);
} else {
}


var G__9645 = seq__9638;
var G__9646 = chunk__9639;
var G__9647 = count__9640;
var G__9648 = (i__9641 + (1));
seq__9638 = G__9645;
chunk__9639 = G__9646;
count__9640 = G__9647;
i__9641 = G__9648;
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__9638);
if(temp__5457__auto__){
var seq__9638__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__9638__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__9638__$1);
var G__9649 = cljs.core.chunk_rest.call(null,seq__9638__$1);
var G__9650 = c__4550__auto__;
var G__9651 = cljs.core.count.call(null,c__4550__auto__);
var G__9652 = (0);
seq__9638 = G__9649;
chunk__9639 = G__9650;
count__9640 = G__9651;
...
var v = cljs.core.first.call(null,seq__9638__$1);
var temp__5457__auto___9653__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___9653__$1)){
var t_9654 = temp__5457__auto___9653__$1;
each_fixture_fn.call(null,((function (seq__9638,chunk__9639,count__9640,i__9641,t_9654,temp__5457__auto___9653__$1,v,seq__9638__$1,temp__5457__auto__,each_fixture_fn,G__9637,G__9637__$1,env,once_fixtures,each_fixtures,vec__9634,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_9654)));
});})(seq__9638,chunk__9639,count__9640,i__9641,t_9654,temp__5457__auto___9653__$1,v,seq__9638__$1,temp__5457__auto__,each_fixture_fn,G__9637,G__9637__$1,env,once_fixtures,each_fixtures,vec__9634,ns,vars__$1))
);
} else {
}
...
});})(each_fixture_fn,G__9637,G__9637__$1,env,once_fixtures,each_fixtures,vec__9634,ns,vars__$1))
);
});})(each_fixture_fn,G__9637,G__9637__$1,env,once_fixtures,each_fixtures,vec__9634,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9637__$1)].join('')));

}
})());
});
;})(vec__9634,ns,vars__$1))
